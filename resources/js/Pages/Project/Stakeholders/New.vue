<template>
    <div class="border  border-neutral-800 bg-gray-200  rounded-lg overflow-auto">
        <h3 class="px-3 py-3 font-semibold text-sm text-white bg-gray-700">
            {{ $trnsl('messages.createStakeholder') }}
        </h3>
...
<script setup>
    ...
    const save = () => {
        props.form.post(route('project.stakeholders.store'), {
            onSuccess: () => { 
