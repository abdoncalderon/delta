...
<script setup>
    ...
    const headers = [
                    {name: 'name', text: trnsl('content.department'), type: 'text', align: 'left'},
    ...
    const fields = [
                    {name: 'id', type: 'hidden'},
                    {name: 'family_id', type: 'select', text: trnsl('content.family'), style: 'sm:col-span-4', items:[], disabled: true}, 
                    {name: 'name', type: 'text', text: trnsl('content.name'), style: 'sm:col-span-4', lenght: 255, disabled: false },
                    {name: 'code', type: 'text', text: trnsl('content.code'), style: 'sm:col-span-4', lenght: 255, disabled: false },
                    {name: 'description', type: 'text', text: trnsl('content.description'), style: 'sm:col-span-4', lenght: 255, disabled: false },
                ];
