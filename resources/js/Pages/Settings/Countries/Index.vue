...
<script setup>
    ...
    const fields = [
        ...
        {name: 'ccc', type: 'text', text: 'CCC', style: 'sm:col-span-2', length: 255 },
        {name: 'region_id', type: 'select', text: trnsl('content.region'), items:[], style: 'sm:col-span-4' },
    ];
