...
<script setup>
    ...
    const fields = [
                    ...
                    {name: 'text', type: 'text', text: trnsl('content.text'), style: 'sm:col-span-4', lenght: 255 },
                    {name: 'route', type: 'text', text: trnsl('content.route'), style: 'sm:col-span-4', lenght: 255 },
                    {name: 'icon', type: 'text', text: trnsl('content.icon'), style: 'sm:col-span-4', lenght: 255 },
                    {name: 'father', type: 'select', text: trnsl('content.father'), style: 'sm:col-span-4', items:[]},
                ];
