...
<script setup>
    ...
    const fields = [
                    {name: 'id', type: 'hidden'},
                    {name: 'name', type: 'text', text: trnsl('content.name'), style: 'sm:col-span-2', lenght: 255 },
                    {name: 'code', type: 'text', text: trnsl('content.code'), style: 'sm:col-span-2', lenght: 255 },
                ];
