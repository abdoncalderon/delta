...
<body>
    <div class="container">
        {{-- <div class="logos">
            <div class="logo1">
                <img src="http://delta.test/storage/kapatax/logo.jpg" alt="logo" style="float: left;">
            </div>
            <div class="logo2">
                <img src="http://delta.test/storage/kapatax/logo.jpg" alt="logo" style="float: right;">
            </div>
        </div> --}}
        <div class="title">
        ...
        <div class="data">
            ...
            <div class="item">
                <p><strong>{{ __('content.expectedCost') }}</strong></p>
            </div>
            <div class="value">
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%; text-align: center;">{{ __('content.measurement') }}</th>
                    </tr>
                </thead>
                <tbody>
        ...
        <div class="buttons">
            <a class="button-approve" href="{{ route('myApprovals.approveMail',[$needRequest->id,4]) }}">{{  __('content.approve') }}</a> 
            <a class="button-reject" href="{{ route('myApprovals.approveMail',[$needRequest->id,3]) }}">{{  __('content.reject') }}</a>
        </div>
    </div>
