...
class CreateProjectsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('projects', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('stakeholder1_id')->nullable();
            $table->unsignedBigInteger('stakeholder2_id')->nullable();
            $table->unsignedBigInteger('stakeholder3_id')->nullable();
            $table->unsignedBigInteger('stakeholder4_id')->nullable();
            $table->timestamps();
        });
    }
